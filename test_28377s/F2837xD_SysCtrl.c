...
#else
//    InitSysPll(XTAL_OSC, IMULT_18, FMULT_0, PLLCLK_BY_2); //180Mhz


#endif // _LAUNCHXL_F28379D
#ifdef _FLASH
    InitSysPll(XTAL_OSC, IMULT_19, FMULT_0, PLLCLK_BY_2);  //180Mhz
#else
    InitSysPll(XTAL_OSC, IMULT_20, FMULT_0, PLLCLK_BY_2);  //200Mhz
#endif
